...
import { seedPromotions } from './promotions-seed'; // Add this import at the top
...
async function main() {
  ...
  // Create sample commercial agent
  ...
  // Create brands
   // Create brands - EXPANDED
  console.log('Creating sample brands...');
  const brands = [
    // International Beauty & Cosmetics
  ...
  // Create sample products - MASSIVELY EXPANDED
  ...
  for (const product of products) {
    ...
    // Add price tiers for wholesale
    const priceTiers = [
      { minQuantity: 10, pricePerUnit: product.basePrice * 0.95 }, // 5% discount for 10+
      { minQuantity: 50, pricePerUnit: product.basePrice * 0.90 }, // 10% discount for 50+
      { minQuantity: 100, pricePerUnit: product.basePrice * 0.85 }, // 15% discount for 100+
    ];
  ...
  // *** SEED PROMOTIONS - Add this line here ***
  await seedPromotions();

  // Create promotional sliders
